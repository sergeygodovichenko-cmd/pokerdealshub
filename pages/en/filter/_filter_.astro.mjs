...
You viewed deals for <span class="font-semibold text-gold">${content.title}</span>. We have many other poker deals with great terms.${" "} <a href="/en/deals/" class="text-gold hover:text-gold-light underline">Show all deals</a> </p> </div>`, content.seoText, unescapeHTML(JSON.stringify({
...
}, "/Users/sergiigodovychenko/Documents/pdh/src/pages/en/filter/[filter].astro", void 0);

const $$file = "/Users/sergiigodovychenko/Documents/pdh/src/pages/en/filter/[filter].astro";
const $$url = "/en/filter/[filter]";
