...
const $$DealsList = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const texts = {
    ru: { more: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0435\u0449\u0451", loading: "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..." },
    en: { more: "Show more", loading: "Loading..." },
    es: { more: "Mostrar m\xE1s", loading: "Cargando..." }
  };
  const t = texts[lang] || texts["en"];
  return renderTemplate`${maybeRenderHead()}<div id="deals-section"> <div id="deals-list" class="flex flex-col gap-4"> ${pageSlice.map((deal) => renderTemplate`${renderComponent($$result, "DealCard", $$DealCard, { "deal": deal })}`)} </div> <div id="observer-trigger" class="h-6 w-full"></div> ${currentPage + 1 < totalPages && renderTemplate`<div class="mt-6 flex justify-center"> <button id="load-more" class="px-6 py-3 rounded-xl bg-gold text-neutral-900 font-bold hover:bg-gold-light transition"${addAttribute(currentPage, "data-current-page")}${addAttribute(totalPages, "data-total-pages")}${addAttribute(lang, "data-lang")}> ${t.more} </button> </div>`} <div id="deals-loader" class="flex justify-center py-4" style="display:none"> <span class="animate-pulse text-neutral-400">${t.loading}</span> </div> </div> ${renderScript($$result, "/Users/sergiigodovychenko/Documents/pdh/src/components/DealsList.astro?astro&type=script&index=0&lang.ts")}`;
